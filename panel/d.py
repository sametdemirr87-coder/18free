...
(function() {
    ...
    async function unlockWithKey(key, silent = false) {
        ...
        if (!silent) setGateLoading(true, 'Loading Nexus Free Bot...');
        try {
...
class MinerBytsPanel(tk.Tk):
    ...
    def build_ui(self):
        ...
        tk.Label(header, text="MINERBYTSFREE VIP PANEL", bg="#0b1020", fg="#60a5fa", font=("Segoe UI", 18, "bold")).pack(side="left")
